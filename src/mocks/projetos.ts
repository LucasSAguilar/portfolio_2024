...
import { tecnologias as tech } from "./tecnologias";
...
const projetos = [
  // Trabalhos reais ---
  {
    ...
    tecnologias: [tech.ReactJS, tech.SQLite, tech.NodeJS],
  },
  {
    id: "2",
    titulo: "Cartão Azul",
    descricao:
      "Aplicativo para emissão e controle de documento para pessoas com Transtorno do Espectro Autista (TEA)",
    video: "",
    codigo: "",
    site: "",
    tipo: "Trabalhos",
    ...
    tecnologias: [tech.Javascript, tech.SQLite, tech.NodeJS],
  },
  {
    id: "3",
    titulo: "Commandas",
    descricao:
      "Sistema para gestão de restaurante, contando com aplicativo mobile, desktop, banco de dados e API para gerenciamento das informações",
    ...
    tecnologias: [tech.ReactJS, tech.MySQL, tech.NodeJS, tech.ReactNative],
  },
  // API ----
  {
    id: "4",
    ...
    tecnologias: [tech.Javascript, tech.MySQL, tech.NodeJS],
  },
  {
    id: "5",
    titulo: "Via CEP",
    ...
    tecnologias: [tech.Javascript, tech.HTML, tech.CSS],
  },
  // Sites expositivos ----
  {
    id: "6",
    ...
    tecnologias: [tech.ReactJS, tech.SCSS, tech.HTML],
  },
  {
    id: "7",
    titulo: "Serenatto",
    ...
    tecnologias: [tech.Javascript, tech.HTML, tech.Bootstrap],
  },
  {
    id: "8",
    titulo: "Meteora",
    ...
    tecnologias: [tech.HTML, tech.CSS, tech.Bootstrap],
  },
  {
    id: "9",
    titulo: "Cinetag",
    ...
    tecnologias: [tech.ReactJS, tech.CSS, tech.HTML],
  },
  // Jogos ----
  {
    id: "10",
  ...
  },
  {
    ...
    tecnologias: [tech.Java, tech.MySQL],
  },
];
